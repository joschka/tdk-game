...
function ConditionalEventNews({newsId, title, text, newspaper, onClick}) {
  ...
  function NewsImage() {
    if (newsId === 1) return <img src={news1} className="conditional-event-news__image" />
    if (newsId === 2) return <img src={news2} className="conditional-event-news__image" />
    if (newsId === 3) return <img src={news3} className="conditional-event-news__image" />
    if (newsId === 4) return <img src={news4} className="conditional-event-news__image" />
    if (newsId === 5) return <img src={news5} className="conditional-event-news__image" />
    if (newsId === 6) return <img src={news6} className="conditional-event-news__image" />
    if (newsId === 7) return <img src={news7} className="conditional-event-news__image" />
    if (newsId === 8) return <img src={news8} className="conditional-event-news__image" />
  }
