...
function LoveChart(props) {
  ...
  function renderChart() {
    return <div className='love-chart__svg-container'>
      <div className='love-chart__slide' style={slideStyle}>
        <svg width={slideWidth} height={height} viewBox={`0 0 ${slideWidth} ${height}`} preserveAspectRatio='xMidYMid meet' style={svgStyle}>
          <defs>
            ...
            <clipPath id='show-bottom-only'>
              <rect x='0' y={thresholdY} width={slideWidth} height={thresholdPercentage * height * 0.01} />
            </clipPath>
          </defs>

          <path d={d} fill='transparent' strokeWidth='3' stroke={positiveColor} clipPath='url(#show-top-only)' />
          <path d={d} fill='transparent' strokeWidth='3' stroke={negativeColor} clipPath='url(#show-bottom-only)' />
          <line x1='0' y1={thresholdY} x2={slideWidth} y2={thresholdY} strokeWidth='1' stroke='#111111' />
        </svg>
      </div>
    </div>;
  }
  ...
  function renderHeart() {
    const color = currentLove >= thresholdPercentage ? positiveColor : negativeColor;
    return <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -256 1850 1850' className='love-chart__heart'>
      <g transform='matrix(1,0,0,-1,37.966102,1343.4237)'>
        <path fill={color} d='m 896,-128 q -26,0 -44,18 L 228,492 q -10,8 -27.5,26 Q 183,536 145,583.5 107,631 77,681 47,731 23.5,802 0,873 0,940 q 0,220 127,344 127,124 351,124 62,0 126.5,-21.5 64.5,-21.5 120,-58 55.5,-36.5 95.5,-68.5 40,-32 76,-68 36,36 76,68 40,32 95.5,68.5 55.5,36.5 120,58 64.5,21.5 126.5,21.5 224,0 351,-124 127,-124 127,-344 0,-221 -229,-450 L 940,-110 q -18,-18 -44,-18'/>
      </g>
    </svg>;
  }
